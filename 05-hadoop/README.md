...
try:
    ...
    print("🔍 Пример сохраненных данных из HDFS:")<img width="1492" height="967" alt="image" src="https://github.com/user-attachments/assets/7205aa1c-c6f9-4df0-8e5d-a3cefc7ca75c" />
...
## [Код анализа данных](https://github.com/Bashashkin/BigData-storage-tools/blob/main/lab5_1.ipynb)
...
* Всего районов: 306
* Всего домов: 13414
* Средняя цена дома: $922,026.35
* Медианная цена: $856,144.44
* Минимальная цена: $380,736.11
* Максимальная цена: $1,930,158.00
* Стандартное отклонение цены: $327,218.44
* Корреляция цена-объем: $0.34

## Вывод

В ходе лабораторной работы был успешно выполнен комплексный анализ рынка недвижимости Мельбурна с использованием современных технологий больших данных. Работа демонстрирует полный цикл обработки данных - от извлечения до визуализации и бизнес-анализа.
